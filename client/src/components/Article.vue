<template>
  <div class="card row flex-row align-items-center">
    ...
    >
      <a href class="edit">
        <img
          src="https://i.ibb.co/mH5FmcC/round-create-black-18dp.png"
          alt="edit"
      ...
      <a href class="delete">
        <img
          src="https://i.ibb.co/qsd95Nh/round-delete-sweep-black-18dp.png"
          alt="delete"
...
<script>
export default {
  props: ["id", "title", "content", "featuredImage"],
  methods: {
    deleteArticle(id) {
