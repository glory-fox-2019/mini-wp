...
},{}],"scr/component/navbar.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $225085 = exports.default || module.exports;
      
      if (typeof $225085 === 'function') {
        $225085 = $225085.options;
      }
    
        /* template */
        Object.assign($225085, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c(
    "nav",
    { staticClass: "p-0 pl-5 navbar", attrs: { id: "navbar" } },
    [
      _vm._m(0),
      _vm._v(" "),
      _c("div", [
        _vm.islogin
          ? _c(
              "ul",
              { staticClass: "userBtn", attrs: { id: "btnAfterLogin" } },
              [
                _c("li", [
                  _c(
                    "button",
                    {
                      staticClass: "btn btn-sign mr-4",
                      on: {
          ...
          : _c(
              "ul",
              { staticClass: "userBtn", attrs: { id: "btnBeforeLogin" } },
              [
                _vm.homeForm
                  ? _c("li", [
                      _c("div", {
                        staticClass: "g-signin2 mr-4",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$225085', $225085);
          } else {
            api.reload('$225085', $225085);
          }
        }
...
},{"./../../css/pics/logo.png":[["logo.6df9a09f.png","css/pics/logo.png"],"css/pics/logo.png"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"scr/component/footer.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $5c7677 = exports.default || module.exports;
      
      if (typeof $5c7677 === 'function') {
        $5c7677 = $5c7677.options;
      }
    
        /* template */
        Object.assign($5c7677, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  ...
  function() {
    ...
    return _c("footer", { staticClass: "p-4" }, [
      _c("div", { staticClass: "d-flex align-items-center" }, [
        _c("h4", [_vm._v("Contact Us On")])
      ]),
      _vm._v(" "),
      _c("div", { staticClass: "contactBox" }, [
        _c("ul", { staticClass: "contactList mt-3 pl-0" }, [
          _c("li", [
            _c("a", { attrs: { href: "" } }, [
      ...
      _vm._v(" "),
      _c("div", { attrs: { id: "copyrights" } }, [
        _c("h6", [_vm._v("Personal Project")]),
        _vm._v(" "),
        _c("p", [_vm._v("Made by Ardi Pratama © 2019")])
      ])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$5c7677', $5c7677);
          } else {
            api.reload('$5c7677', $5c7677);
          }
        }
...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"scr/app.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    createUser: function createUser() {
      ...
      (0, _axios.default)({
        url: "".concat(url, "/users"),
        method: "post",
        data: data
      }).then(function (data) {
        _this.homeForm = true;
        _this.signUpForm = false;

        _sweetalert.default.fire("Oops...", "Register Success", "success");
      }).catch(function (err) {
        console.log(err);
      });
    },
    postNewArticle: function postNewArticle() {
      var _this2 = this;
      ...
      (0, _axios.default)({
        ...
        _this2.newArticleContent = "";

        _this2.goToMyArticles();
      }).catch(function (err) {
        console.log(err);
      });
    },
    ...
    editMyArticle: function editMyArticle(id) {
      var _this4 = this;
      ...
      (0, _axios.default)({
        url: "".concat(url, "/articles/").concat(id),
        method: "patch",
        headers: {
          token: token
        },
        ...
        var data = _ref4.data;
        _this4.editForm = false;
        _this4.myArticle = true;
        console.log(data);
      }).catch(function (err) {
        console.log(err);
      });
    },
    goToDeleteArticle: function goToDeleteArticle(id) {
      var _this5 = this;

      var token = localStorage.getItem("token"); // console.log(id);
      ...
      (0, _axios.default)({
        ...
        _this5.articlesFeeds = _this5.articlesFeeds.filter(function (article) {
    ...
    goToEditArticle: function goToEditArticle(article) {
    ...
    goToMyArticles: function goToMyArticles() {
      var _this6 = this;
      ...
      (0, _axios.default)({
        ...
        var data = _ref5.data;
        _this6.articlesFeeds = data;
        _this6.editForm = false;
        _this6.articleList = false;
        _this6.createNew = false;
        _this6.articleForm = false;
        _this6.myArticle = true;
      }).catch(function (err) {
        console.log(err);
      });
    },
    goToArticle: function goToArticle(id) {
      ...
      (0, _axios.default)({
        ...
        var data = _ref6.data;
        _this7.editForm = false;
        _this7.articleInfo = data;
        _this7.articleForm = true;
        _this7.myArticle = false;
        _this7.articleList = false;
        console.log(data);
      }).catch(function (err) {
        console.log(err);
      });
    },
    goToArticleFeeds: function goToArticleFeeds() {
      var _this8 = this;

      var token = localStorage.getItem("token");
      (0, _axios.default)({
        url: "".concat(url, "/articles/all"),
        method: "get",
        headers: {
          token: token
        }
        ...
        var data = _ref7.data;
        _this8.editForm = false;
        _this8.articlesFeeds = data;
        _this8.myArticle = false;
        _this8.articleList = true;
        _this8.createNew = false;
        _this8.articleForm = false;
      }).catch(function (err) {
        console.log(err);
      });
    },
    goToNewArticle: function goToNewArticle() {
      this.editForm = false;
      this.articleForm = false;
      this.myArticle = false;
      this.articleList = false;
...
exports.default = _default;
        var $b95f3c = exports.default || module.exports;
      
      if (typeof $b95f3c === 'function') {
        $b95f3c = $b95f3c.options;
      }
    
        /* template */
        Object.assign($b95f3c, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [_c("Navbar"), _vm._v(" "), _c("Footer")], 1)
}
var staticRenderFns = []
render._withStripped = true
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b95f3c', $b95f3c);
          } else {
            api.reload('$b95f3c', $b95f3c);
          }
        }
...
},{"axios":"node_modules/axios/index.js","sweetalert2":"node_modules/sweetalert2/dist/sweetalert2.all.js","./component/navbar":"scr/component/navbar.vue","./component/footer":"scr/component/footer.vue","_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"main.js":[function(require,module,exports) {
"use strict";

var _vue = _interopRequireDefault(require("vue"));

var _app = _interopRequireDefault(require("./scr/app.vue"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

new _vue.default(_app.default).$mount('#app');
},{"vue":"node_modules/vue/dist/vue.runtime.esm.js","./scr/app.vue":"scr/app.vue"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
